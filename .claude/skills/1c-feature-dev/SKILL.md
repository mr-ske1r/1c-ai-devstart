---
name: 1c-feature-dev
description: "Используй этот скилл всякий раз, когда пользователь хочет получить доработку 1С целиком — от постановки до готового кода. Сюда относятся «создать доработку 1С», «реализовать функционал», «добавить новую возможность», «разработать модуль», «сделать доработку», «доведи задачу до конца», «сделай под ключ», а также случай, когда в работу отдана сырая идея без готового задания. Скилл уточняет требования вопросами, исследует конфигурацию, предлагает архитектуру, составляет план, реализует его и проверяет результат. Если пользователь называет задачу на доработку и ждёт работающий код, используй этот скилл."
---
